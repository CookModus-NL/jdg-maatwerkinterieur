...
export const metadata: Metadata = {
  ...
  description: 'Hoe JDG Maatwerk Interieur omgaat met jouw persoonsgegevens.',
}
  ...
  return (
    <section className="bg-paper py-16 lg:py-24">
      <article className="container-tight">
        ...
        <p className="mt-4 text-ink-500 text-sm">Laatst bijgewerkt: 29 mei 2026</p>

        <div className="mt-12 space-y-8 text-ink-800 leading-relaxed">
          <p>
            {business.legalName} (KvK {business.kvk}) respecteert je privacy en verwerkt persoonsgegevens alleen volgens de AVG. Op deze pagina lees je welke gegevens we verzamelen, waarom en hoe lang.
          </p>

          <section>
            <h2 className="font-display text-2xl font-bold text-ink-950">Verwerkingsverantwoordelijke</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-ink-950">Welke gegevens verzamel ik?</h2>
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-ink-950">Bewaartermijnen</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-ink-950">Jouw rechten</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-ink-950">Doorgifte aan derden</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="font-display text-2xl font-bold text-ink-950">Klachten</h2>
            <p className="mt-3">
              Komen we er samen niet uit? Dan kun je een klacht indienen bij de Autoriteit Persoonsgegevens via{' '}
              <a href="https://www.autoriteitpersoonsgegevens.nl" className="text-jdg-700 underline" target="_blank" rel="noopener noreferrer">autoriteitpersoonsgegevens.nl</a>.
            </p>
          </section>
        </div>
      </article>
